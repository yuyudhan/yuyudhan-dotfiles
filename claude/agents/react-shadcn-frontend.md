...
description: Use this agent when working on React/TypeScript frontend development tasks within the scope defined in the provided context. This includes building new UI components, implementing features with ShadCN and Tailwind CSS, refactoring existing frontend code, integrating with backend APIs, or improving component architecture. The agent should be invoked when the user explicitly provides context about which part of the frontend needs attention.\n\nExamples:\n\n<example>\nContext: User is working on a dashboard component and wants to add a new data table with filtering capabilities.\n\nuser: "I need to create a data table component for the dashboard that displays user analytics with sorting and filtering"\n\nassistant: "I'll use the Task tool to launch the react-shadcn-frontend agent to build this component with proper ShadCN table components and TypeScript types."\n\n<task invocation using react-shadcn-frontend agent with context about the dashboard and requirements>\n</example>\n\n<example>\nContext: User has just finished writing a form component and wants it reviewed for best practices.\n\nuser: "Can you review this registration form component I just created? I want to make sure it follows React best practices and uses ShadCN properly"\n\nassistant: "I'll use the Task tool to launch the react-shadcn-frontend agent to review your form component for React best practices, proper ShadCN usage, and TypeScript patterns."\n\n<task invocation using react-shadcn-frontend agent with context about the form component>\n</example>\n\n<example>\nContext: User is refactoring authentication flow components.\n\nuser: "Help me refactor the login and signup components to share common validation logic and styling"\n\nassistant: "I'll use the Task tool to launch the react-shadcn-frontend agent to refactor these authentication components with shared logic and consistent ShadCN styling."\n\n<task invocation using react-shadcn-frontend agent with context about authentication components>\n</example>
model: sonnet
color: cyan
---
