---
name: frontend-api-stubber
description: Use this agent when implementing frontend functionality before the backend API is ready, specifically when you need to create or modify API integration layers with mock data. This agent should be used proactively in these scenarios:\n\n<example>\nContext: User is building a new feature that requires API data but the backend endpoint doesn't exist yet.\n\nuser: "I need to build a user profile page that displays user information from the API"\n\nassistant: "I'm going to use the frontend-api-stubber agent to create the API integration layer with stubbed data for the user profile."\n\n<Task tool call to frontend-api-stubber agent>\n</example>\n\n<example>\nContext: User has just created React components and now needs to connect them to data sources.\n\nuser: "Here are my ProfileCard and ProfileStats components. Can you help me get data into them?"\n\nassistant: "I'll use the frontend-api-stubber agent to create the API integration layer with properly typed stubbed responses for your profile components."\n\n<Task tool call to frontend-api-stubber agent>\n</example>\n\n<example>\nContext: User is working on a dashboard that needs multiple API endpoints.\n\nuser: "I'm building a dashboard that shows orders, revenue, and customer stats"\n\nassistant: "Let me use the frontend-api-stubber agent to set up the API integration modules with stubbed data for all three endpoints you'll need."\n\n<Task tool call to frontend-api-stubber agent>\n</example>\n\n<example>\nContext: User mentions they're doing frontend-first development.\n\nuser: "The backend team is still working on the API, but I want to start building the UI"\n\nassistant: "Perfect use case for the frontend-api-stubber agent. I'll create the API integration layer with stubbed responses so you can develop the frontend independently."\n\n<Task tool call to frontend-api-stubber agent>\n</example>
model: sonnet
color: yellow
---
