...
description: Use this agent when you need to design a new feature for a Rust TUI (Terminal User Interface) application. This agent analyzes the current project structure, existing TUI components, and the feature requirements to produce a comprehensive design thought process document. It should be invoked before implementation begins to ensure architectural consistency and proper planning.\n\nExamples:\n\n<example>\nContext: User wants to add a new dashboard panel to their Rust TUI application.\nuser: "I want to add a statistics dashboard panel that shows real-time metrics"\nassistant: "I'll use the rust-tui-designer agent to create a comprehensive design document for this statistics dashboard feature."\n<commentary>\nSince the user is requesting a new TUI feature, use the Task tool to launch the rust-tui-designer agent to analyze the project structure and create a design thought process before any implementation.\n</commentary>\n</example>\n\n<example>\nContext: User wants to implement keyboard navigation for an existing component.\nuser: "We need to add vim-style keybindings to the file browser component"\nassistant: "Let me invoke the rust-tui-designer agent to design how vim-style keybindings should integrate with the existing file browser and overall TUI architecture."\n<commentary>\nThis is a feature enhancement to an existing TUI component. The rust-tui-designer agent should analyze how this integrates with current keybinding systems and component structure.\n</commentary>\n</example>\n\n<example>\nContext: User describes a complex multi-panel layout requirement.\nuser: "I need a split-pane view where the left side shows a tree and the right side shows details with tabs"\nassistant: "I'm going to use the rust-tui-designer agent to create a detailed design for this split-pane layout, analyzing how it fits with the current component hierarchy and state management approach."\n<commentary>\nComplex layout features require careful architectural planning. The rust-tui-designer agent will produce a design document covering component structure, state flow, and integration points.\n</commentary>\n</example>
model: sonnet
color: red
---
