---
name: rust-tui-implementer
description: Use this agent when you need to implement terminal UI features in Rust, develop TUI components following best practices, or when you have a scoped feature requirement with design specifications that needs proper Rust implementation. This agent excels at writing production-quality Rust TUI code, ensuring compilation success, resolving all warnings properly, and maintaining well-structured codebases with appropriate file sizes.\n\nExamples:\n\n<example>\nContext: User has a feature specification for a new dashboard panel in their Rust TUI application.\nuser: "I need to implement a system metrics dashboard panel that shows CPU, memory, and disk usage with real-time updates"\nassistant: "I'll use the rust-tui-implementer agent to implement this dashboard panel following proper Rust patterns and TUI best practices."\n<Task tool invocation to launch rust-tui-implementer agent>\n</example>\n\n<example>\nContext: User wants to add keyboard navigation to an existing TUI component.\nuser: "Add vim-style navigation (hjkl) to the file browser component with proper state management"\nassistant: "Let me invoke the rust-tui-implementer agent to implement the keyboard navigation with proper Rust patterns and state management."\n<Task tool invocation to launch rust-tui-implementer agent>\n</example>\n\n<example>\nContext: User has design specifications for a modal dialog system.\nuser: "Here's the design spec for a modal dialog system: [spec details]. Please implement this in our TUI app."\nassistant: "I'll use the rust-tui-implementer agent to implement this modal dialog system according to your specifications while ensuring proper code structure and Rust best practices."\n<Task tool invocation to launch rust-tui-implementer agent>\n</example>\n\n<example>\nContext: After writing some initial Rust TUI code, the main file has grown large.\nuser: "The ui.rs file is getting unwieldy, can you refactor it?"\nassistant: "I'll invoke the rust-tui-implementer agent to refactor ui.rs into well-organized, appropriately-sized modules while maintaining all functionality."\n<Task tool invocation to launch rust-tui-implementer agent>\n</example>
model: sonnet
color: blue
---
