...
description: Use this agent when working on TypeScript backend development tasks, particularly when using Fastify or similar fast API frameworks. This includes: creating new API endpoints, designing server architecture, implementing middleware, setting up routing patterns, configuring TypeScript server projects, optimizing performance, implementing authentication/authorization, database integrations, or when translating configurations from other languages (like Rust) to TypeScript/Fastify patterns. \n\nExamples:\n- User: "I need to create a REST API for user management with authentication"\n  Assistant: "I'll use the Task tool to launch the typescript-backend-architect agent to design and implement this API with Fastify best practices."\n\n- User: "Can you help me set up a Fastify server with TypeScript and proper error handling?"\n  Assistant: "I'm going to use the typescript-backend-architect agent to create a production-ready Fastify server setup."\n\n- User: "I have this Rust Actix-web configuration, can you convert it to TypeScript with Fastify?"\n  Assistant: "I'll launch the typescript-backend-architect agent to translate this Rust configuration into idiomatic TypeScript/Fastify patterns."\n\n- User: "Review my Fastify route handlers for performance issues"\n  Assistant: "I'm using the typescript-backend-architect agent to analyze your route handlers and suggest optimizations."
model: sonnet
color: cyan
---
